...
resourcegroup_name = 'svns'+''.join(random.choice(string.ascii_lowercase + string.digits) for _ in range(6))
storageaccount_name = 'svns'+''.join(random.choice(string.ascii_lowercase + string.digits) for _ in range(6))
location = 'westus'
...
cars.RowKey = '001'
cars.make = 'Crvena Zastava'
cars.model = '750'
cars.year = 1955
cars.color = 'Blue'
cars.price = 100
table_service.insert_entity('itemstable', cars)
print('Created entry for Fitja...')

cars = Entity()
cars.PartitionKey = 'cardealership'
cars.RowKey = '002'
cars.make = 'Trabant'
cars.model = '601 Estate'
cars.year = 1963
cars.color = 'White'
cars.price = 100
table_service.insert_entity('itemstable', cars)
print('Created entry for Trabant ...')
...
cars.price = 100
table_service.insert_entity('itemstable', cars)
print('Created entry for Wartburg...\n')
...
print('Created entry for a C kafa...\n')
time.sleep(1)

coffee = Entity()
coffee.PartitionKey = 'coffeeshop'
coffee.RowKey = '006'
coffee.brand = 'Grand kafa'
coffee.flavor = 'chai latte'
coffee.cupsize = 12
coffee.pricepercup = 2
table_service.insert_entity('itemstable', coffee)
print('Created entry for Grand ...\n')
time.sleep(1)
